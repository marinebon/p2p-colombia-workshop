...
[MBON Pole to Pole](https://marinebon.org/p2p/) & [AmeriGEO](https://www.amerigeoss.org) <br>
...
This third workshop continues to build on activities and achieved goals from training activities in [Brazil](https://marinebon.org/p2p-brazil-workshop/) and [Mexico](https://marinebon.org/p2p-mexico-workshop/). The purpose is to continue the development of a community of practice dedicated to understanding change in marine biodiversity and generating knowledge and products that inform conservation and management efforts across the Americas. 

During this workshop participants will:

1. Learn to survey rocky shores using photo-quadrat collection and imagery analysis;
1. Develop specific Dawin Core vocabularies for flora and fauna of rocky shore and sandy beach measured during field surveys;
1. Publish survey datasets collected during 2019 and 2020 to the Ocean Biogeographic Information System ([OBIS](http://www.iobis.org/));
...
The workshop targets investigators and resource managers dedicated to studying and conserving biodiversity of invertebrates in three important coastal habitats: rocky shore intertidal zone, sandy beaches and seagrass beds (in collaboration with [MarineGEO](https://marinegeo.si.edu/)). This activity targets participants from all nations in the Americas, from pole to pole.

## Instructors
- Enrique Montes ([IMaRS](http://imars.usf.edu/); USF) - Project lead and workshop coordinator
- Patricia Miloslavich (SCOR) - TBD
- Emmett Duffy ([MarineGEO](https://marinegeo.si.edu/initiative/leadership)) - TBD
...
- Others? I propose Juan Pablo Livore, Gonzalo Bravo or Maria (Pitu) Mendez (CENPAT - IBIOMAR, Argentina) for photo-quadrats
...
- [Sampling protocol for assessment of marine diversity on rocky shores. (Modified from the SARCE South American Research Group on Coastal Ecosystems for sampling on rocky shores protocol)](https://www.oceanbestpractices.net/handle/11329/1143)
...
- [Sampling protocol for assessment of marine diversity on sandy beaches](https://www.oceanbestpractices.net/handle/11329/1145)

- [Step-by-step taxonomy quality control with WoRMS](https://marinebon.org/p2p/protocols/WoRMS_quality_check.pdf)

- [HOW TO upload and publish your data in OBIS and GBIF](https://diodon.github.io/P2P/PublishingDataIPT.html)

- MarineGEO [Seagrass Monitoring Protocol](https://marinegeo.github.io/seagrass)
...
The Application Survey will be closed **January 31, 2020**, at midnight (EST). Candidates will receive notice of acceptance by **February 28th, 2020**. Selected participants must confirm attendance to the workshop by replying to the acceptance notification email before **March 20, 2020**.
...
2) have completed at least one biodiversity surveys at their study sites in **2019**;
3) are able to bring previously collected biodiversity survey data to the workshop;
4) are willing to upload their data to [OBIS](http://www.iobis.org/);
