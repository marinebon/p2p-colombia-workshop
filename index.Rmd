...
1. Learn to access and use satellite seascapes and other remote sensing variables to characterize environmental conditions at survey sites. 
1. Test methods for assessing rocky shore biodiversity using photo-quadrats and imagery analysis;
...
The workshop targets investigators and resource managers dedicated to studying and conserving biodiversity of invertebrates in three important coastal habitats: rocky shore intertidal zone, sandy beaches. This activity will be carried out in coordination with the Seagrass [MarineGEO](https://marinegeo.si.edu/). This activity targets participants from all nations in the Americas, from pole to pole.
...
The Application Survey will be closed **January 31, 2020**, at midnight (EST). Candidates will receive notice of acceptance by **February 21st**. Selected participants must confirm attendance to the workshop by replying to the acceptance notification email before **March 6th**.
...
3) have applied sampling protocols of the MBON Pole to Pole network;
